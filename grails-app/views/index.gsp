...
<head>
    ...
    <!----webfonts---->
    <link href='css/bootstrap/google_apis_raleway.css' rel='stylesheet' type='text/css'>
            <!----//webfonts---->
            <!----requred-js-files---->
...
<div class="head-bg sTop">
    <div class="conatiner">
        <div class="col-lg-12 header-note">
            <a href="#"><img src="images/logo.png" title="ResumeBuilder" /></a>
            <h1>Build your Resume Superfast</h1>
            %{--<h4> Now building a quality resume is two minute job </h4>--}%
            <a class="btn btn-primary big-btn" href="#">Try Us<span> </span></a>
        ...
        <div class="collapse navbar-collapse navbar-left navbar-main-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="page-scroll">
                    <a id="s1" class="subNavBtn" href="#">Why Us</a>
                </li>
                <li class="page-scroll">
                    <a id="s2" class="subNavBtn" href="#">Build Yours</a>
                </li>
                <li class="page-scroll">
                    <a id="s3" class="subNavBtn" href="#">We are Growing</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
...
<div class="portfolio section s2">
    <div class="container portfolio-head">
        <h3> Top 10 most used Templates </h3>
        <p> </p>
    </div>
...
<div class="contact section s4">
    <div class="container">
        ...
        <p class="contact-head">Have any suggestion? Any feedback? Let us know.</p>
        ...
        <div class="copy-right">
            <p>Copyright &#169; 2015<span><a href="#"> ResumeBuilder </a></span> All Rights Reserved.</p>
        </div>
        <!----//End-copy-right---->
    </div>
</div>
